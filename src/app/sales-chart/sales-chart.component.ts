...
export class SalesChartComponent implements OnInit {
  ...
  public barChartLabels: any[] = [this.today.substring(0,10), this.yesterday.substring(0,10), this.lastThirdDay.substring(0,10), this.lastFourthDay.substring(0,10), this.fiveDays.substring(0,10)];
